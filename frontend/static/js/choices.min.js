...
!(function (e, t) {
  ...
  var s,
    ...
    T = function (e, t, i) {
      return "function" == typeof e ? e(I(t), O(t), i) : e;
    },
    N = function (e, t) {
      return e ? L(t) : I(t);
    },
    ...
    B = (function () {
      ...
      return (
        ...
        (e.prototype.addInvalidState = function () {
          j(this.element, this.classNames.invalidState);
        }),
    ...
    q = (function () {
      ...
      return (
        ...
        (e.prototype.conceal = function () {
          var e = this.element;
          j(e, this.classNames.input), (e.hidden = !0), (e.tabIndex = -1);
    ...
    z = function (e, t, i) {
      ...
      return {
        ...
        active: U(c.active),
        selected: U(c.selected, !1),
        disabled: U(c.disabled, !1),
        placeholder: U(c.placeholder, !1),
        highlighted: !1,
        labelClass: G(c.labelClass),
              ...
              (e.setAttribute("value", ""), (e.value = "")),
            {
              ...
              labelClass:
                void 0 !== e.dataset.labelClass
                  ? G(e.dataset.labelClass)
                  : void 0,
              labelDescription:
                void 0 !== e.dataset.labelDescription
                  ? e.dataset.labelDescription
                  : void 0,
              customProperties: K(e.dataset.customProperties),
            }
          );
        }),
    ...
    Q = {
      ...
      removeItemLabelText: function (e, t, i) {
        return "Remove item: ".concat(i ? I(i.label) : e);
      },
  ...
  function re(e) {
    for (var t = 1; t < arguments.length; t++) {
      ...
      t % 2
        ? oe(Object(i), !0).forEach(function (t) {
            se(e, t, i[t]);
          })
  ...
  function ce(e) {
    return Array.isArray ? Array.isArray(e) : "[object Array]" === pe(e);
  }
  function ae(e) {
  ...
  const fe = (e) => `Missing ${e} property in key`,
    me = (e) => `Property 'weight' in key '${e}' must be a positive integer`,
  ...
  function _e(e) {
    let t = null,
      ...
      s = 1,
      o = null;
    if (ae(e) || ce(e)) (n = e), (t = ye(e)), (i = be(e));
    else {
      if (!ve.call(e, "name")) throw new Error(fe("name"));
      const r = e.name;
      if (((n = r), ve.call(e, "weight") && ((s = e.weight), s <= 0)))
        throw new Error(me(r));
      (t = ye(r)), (i = be(r)), (o = e.getFn);
    }
  ...
  const Ee = {
    ...
    getFn: function (e, t) {
      ...
      return s(e, ae(t) ? t.split(".") : t, 0), n ? i : i[0];
    },
    ignoreLocation: !1,
    ignoreFieldNorm: !1,
    fieldNormWeight: 1,
  ...
  class we {
    constructor({
      getFn: e = Se.getFn,
      fieldNormWeight: t = Se.fieldNormWeight,
    } = {}) {
  ...
  function Ie(
    e,
    t,
    { getFn: i = Se.getFn, fieldNormWeight: n = Se.fieldNormWeight } = {}
  ) {
    const s = new we({ getFn: i, fieldNormWeight: n });
    return s.setKeys(e.map(_e)), s.setSources(t), s.create(), s;
  }
  function Ae(
    e,
    {
      ...
      distance: s = Se.distance,
      ignoreLocation: o = Se.ignoreLocation,
    } = {}
  ) {
    const r = t / e.length;
    if (o) return r;
  ...
  class Le {
    constructor(
      e,
      {
        location: t = Se.location,
        threshold: i = Se.threshold,
        distance: n = Se.distance,
        includeMatches: s = Se.includeMatches,
        findAllMatches: o = Se.findAllMatches,
        minMatchCharLength: r = Se.minMatchCharLength,
        isCaseSensitive: c = Se.isCaseSensitive,
        ignoreLocation: a = Se.ignoreLocation,
      } = {}
    ) {
      if (
        ((this.options = {
        ...
        return;
      const h = (e, t) => {
          this.chunks.push({ pattern: e, alphabet: Oe(e), startIndex: t });
        },
      ...
      if (l > xe) {
        ...
        const t = l % xe,
          i = l - t;
        for (; e < i; ) h(this.pattern.substr(e, xe), e), (e += xe);
        if (t) {
          const e = l - xe;
      ...
      this.chunks.forEach(({ pattern: t, alphabet: d, startIndex: p }) => {
        const {
          ...
          i,
          {
            ...
            distance: s = Se.distance,
            threshold: o = Se.threshold,
            findAllMatches: r = Se.findAllMatches,
            minMatchCharLength: c = Se.minMatchCharLength,
            includeMatches: a = Se.includeMatches,
            ignoreLocation: h = Se.ignoreLocation,
          } = {}
        ) {
          if (t.length > xe)
          ...
          if (m) {
            const e = (function (e = [], t = Se.minMatchCharLength) {
              let i = [],
                n = -1,
                s = -1,
                o = 0;
  ...
  const De = [
    ...
    Fe = De.length,
    Pe = / +(?=(?:[^\"]*\"[^\"]*\")*[^\"]*$)/,
    je = new Set([Ne.type, ke.type]);
  const Re = [];
  function Ke(e, t) {
    for (let i = 0, n = Re.length; i < n; i += 1) {
      let n = Re[i];
  ...
  const Ve = "$and",
    Be = "$path",
    He = (e) => !(!e[Ve] && !e.$or),
    $e = (e) => ({ [Ve]: Object.keys(e).map((t) => ({ [t]: e[t] })) });
  function qe(e, t, { auto: i = !0 } = {}) {
    const n = (e) => {
      let s = Object.keys(e);
      const o = ((e) => !!e[Be])(e);
      if (!o && s.length > 1 && !He(e)) return n($e(e));
      if (((e) => !ce(e) && le(e) && !He(e))(e)) {
        const n = o ? e[Be] : s[0],
          r = o ? e.$val : e[n];
        if (!ae(r)) throw new Error(((e) => `Invalid value for key ${e}`)(n));
        const c = { keyId: be(n), pattern: r };
        return i && (c.searcher = Ke(r, t)), c;
      }
  ...
  function We(e, t) {
    ...
    (t.matches = []),
      ue(i) &&
        i.forEach((e) => {
          if (!ue(e.indices) || !e.indices.length) return;
  ...
  class Ge {
    constructor(e, t = {}, i) {
      (this.options = re(re({}, Se), t)),
        (this._keyStore = new ge(this.options.keys)),
        this.setCollection(e, i);
    }
    setCollection(e, t) {
      if (((this._docs = e), t && !(t instanceof we)))
        throw new Error("Incorrect 'index' type");
      this._myIndex =
        t ||
        Ie(this.options.keys, this._docs, {
          getFn: this.options.getFn,
          fieldNormWeight: this.options.fieldNormWeight,
        });
    }
    add(e) {
      ue(e) && (this._docs.push(e), this._myIndex.add(e));
    }
    remove(e = () => !1) {
      const t = [];
    ...
    search(e, { limit: t = -1 } = {}) {
      ...
      return (
        (function (e, { ignoreFieldNorm: t = Se.ignoreFieldNorm }) {
          e.forEach((e) => {
            let i = 1;
  ...
  (Ge.version = "7.0.0"),
    (Ge.createIndex = Ie),
    (Ge.parseIndex = function (
      e,
      { getFn: t = Se.getFn, fieldNormWeight: i = Se.fieldNormWeight } = {}
    ) {
      const { keys: n, records: s } = e,
        o = new we({ getFn: t, fieldNormWeight: i });
    ...
    (function (...e) {
      ...
      class {
        constructor(
          e,
          {
            isCaseSensitive: t = Se.isCaseSensitive,
            includeMatches: i = Se.includeMatches,
            minMatchCharLength: n = Se.minMatchCharLength,
            ignoreLocation: s = Se.ignoreLocation,
            findAllMatches: o = Se.findAllMatches,
            location: r = Se.location,
            threshold: c = Se.threshold,
            distance: a = Se.distance,
          } = {}
        ) {
          (this.query = null),
            (this.options = {
          ...
          for (let n = 0, c = t.length; n < c; n += 1) {
            ...
            for (let t = 0, n = c.length; t < n; t += 1) {
              ...
              (s += 1),
                (r += l),
                i &&
                  (je.has(n.constructor.type) ? (o = [...o, ...h]) : o.push(h));
            }
            if (s) {
  ...
  var ze = (function () {
      ...
      return (
        ...
        (e.prototype.search = function (e) {
          return (
            this._fuse ||
              (this._fuse = new Ge(this._haystack, this._fuseOptions)),
    ...
    Qe = {
        ...
        return (
          ...
          i &&
            ...
            s
              ...
              : r || Xe(this._docRoot, this.passedElement.element.id, a),
      ...
      item: function (e, t, i) {
        ...
        if ((j(f, a), t.labelClass)) {
          var m = document.createElement("span");
          k(m, n, t.label), j(m, t.labelClass), f.appendChild(m);
        } else k(f, n, t.label);
        if (
          ((f.dataset.item = ""),
          (f.dataset.id = t.id),
          ...
          t.placeholder && (j(f, d), (f.dataset.placeholder = "")),
          j(f, t.highlighted ? l : u),
          i)
        ) {
          t.disabled && R(f, u), (f.dataset.deletable = "");
      ...
      choiceGroup: function (e, t) {
        ...
        return j(d, o), k(d, i, a || ""), u.appendChild(d), u;
      },
      choice: function (e, t, i, n) {
        ...
        (m.id = t.elementId),
          ...
          n &&
            "string" == typeof p &&
            ((p = N(s, p)), (p = { trusted: (p += " (".concat(n, ")")) }));
        var v = m;
        if (t.labelClass) {
          var g = document.createElement("span");
          k(g, s, p), j(g, t.labelClass), (v = g), m.appendChild(g);
        } else k(m, s, p);
        if (t.labelDescription) {
          var _ = "".concat(t.elementId, "-description");
          v.setAttribute("aria-describedby", _);
          var y = document.createElement("span");
          k(y, s, t.labelDescription), (y.id = _), j(y, u), m.appendChild(y);
        }
        return (
          t.selected && j(m, h),
          t.placeholder && j(m, d),
      ...
      input: function (e, t) {
        ...
        return (
          ...
          t
            ...
            : o || Xe(this._docRoot, this.passedElement.element.id, r),
          r
        );
      },
      dropdown: function (e) {
        var t = e.classNames,
          ...
          n = t.listDropdown,
          s = document.createElement("div");
        return j(s, i), j(s, n), s.setAttribute("aria-expanded", "false"), s;
      },
      notice: function (e, t, i) {
        ...
        switch ((k(l, !0, t), j(l, s), j(l, o), j(l, h), i)) {
          case ne:
            j(l, r);
            break;
          case ie:
  ...
  return (function () {
    function e(t, n) {
      ...
      if (!a || "object" != typeof a || ("INPUT" !== a.tagName && !J(a))) {
      ...
      if (
        ((this.passedElement = this._isTextElement
          ? new W({ element: a, classNames: r.classNames })
          : new X({
              element: a,
    ...
    return (
      ...
      (e.prototype.init = function () {
        if (!this.initialised && void 0 === this.initialisedOK) {
          (this._searcher = new ze(this.config)),
            this._loadChoices(),
      ...
      (e.prototype.highlightItem = function (e, t) {
        ...
        return (
          !i ||
            ...
            t && this.passedElement.triggerEvent(v, M(i))),
          this
        );
      }),
      (e.prototype.unhighlightItem = function (e, t) {
        ...
        return i && i.highlighted
          ? (this._store.dispatch(C(i, !1)),
            t && this.passedElement.triggerEvent("unhighlightItem", M(i)),
            this)
          : this;
      }),
          ...
          this._store.withTxn(function () {
            e._store.items.forEach(function (t) {
              t.highlighted ||
                ...
                e.passedElement.triggerEvent(v, M(t)));
            });
          }),
          this
        );
        ...
        return (
          ...
          this._store.withTxn(function () {
            ...
            e.forEach(function (e) {
              if ("choices" in e) {
                var s = e;
                h || (s = i(i({}, s), { label: s[n] })), c._addGroup(z(s, !0));
              } else {
                var o = e;
      ...
      (e.prototype.removeChoice = function (e) {
        ...
        return t
          ? (this._clearNotice(),
            ...
            this._searcher.reset(),
            t.selected && this.passedElement.triggerEvent(m, M(t)),
            this)
          : this;
      }),
      ...
      (e.prototype._renderChoices = function () {
        ...
        if (this._canAddItems()) {
          ...
          var a = document.createDocumentFragment(),
            ...
            d = null,
            p = function (n, s) {
              i ? n.sort(D) : t.shouldSort && n.sort(t.sorter);
              var o = n.length;
              (o = !s && r > 0 && o > r ? r : o),
                o--,
          ...
          o.length &&
            ...
            u ||
              ...
              (this._notice ||
                (this._notice = {
                  text: x(i ? t.noResultsText : t.noChoicesText),
                  type: i ? ie : te,
                }),
              a.replaceChildren("")),
      ...
      (e.prototype._renderItems = function () {
        ...
        if (this._isSelectOneElement) {
          ...
          if (c || a > 1) {
            var h = i.querySelector(P(n.classNames.placeholder));
            h && h.remove();
          } else
            c ||
              a ||
      ...
      (e.prototype._clearNotice = function () {
        if (this._notice) {
          var e = this.choiceList.element.querySelector(
            P(this.config.classNames.notice)
          );
        ...
        if (this._isTextElement) {
          if (
            ...
            var n = this.passedElement.value
              .split(i.delimiter)
              .map(function (e) {
                return z(e, !1, t.config.allowHtmlUserInput);
              });
      ...
      (e.prototype._canAddItems = function () {
        ...
        return !e.singleModeForMultiSelect &&
          ...
          ? (this.choiceList.element.replaceChildren(""),
            (this._notice = void 0),
            this._displayNotice("function" == typeof i ? i(t) : i, ne),
            !1)
          : (this._notice && this._notice.type === ne && this._clearNotice(),
            !0);
      }),
      (e.prototype._canCreateItem = function (e) {
        ...
        if (
          (i &&
            ...
            !t.addItemFilter(e) &&
            ((i = !1), (n = T(t.customAddItemText, e, void 0))),
          i &&
            this._store.choices.find(function (i) {
              return t.valueComparer(i.value, e);
            }))
        ) {
          if (this._isSelectElement) return this._displayNotice("", ne), !1;
          t.duplicateItemsAllowed ||
            ((i = !1), (n = T(t.uniqueItemText, e, void 0)));
        }
        return (
          i && (n = T(t.addItemText, e, void 0)),
          n && this._displayNotice(n, ne),
          i
        );
      }),
      (e.prototype._searchChoices = function (e) {
        ...
        return (
          (s && s.type) !== ne &&
            (n.length
              ? this._clearNotice()
              : this._displayNotice(x(this.config.noResultsText), ie)),
          this._store.dispatch(
            (function (e) {
      ...
      (e.prototype._onEnterKey = function (e, t) {
        ...
        if ((e.preventDefault(), s && s.hasAttribute("data-button")))
          ...
          var o = this.dropdown.element.querySelector(
            P(this.config.classNames.highlightedState)
          );
              ...
              if (this._canAddItems()) {
                ...
                this._store.withTxn(function () {
                  if (!(r = i._findAndSelectChoiceByValue(n, !0))) {
                    ...
                    i._addChoice(z(n, !1, i.config.allowHtmlUserInput), !0, !0),
                      (r = !0);
                  }
        ...
        if (t || this._isSelectOneElement) {
          ...
          if (e.metaKey || 34 === o || 33 === o)
            ...
            c = a
              ...
              : this.dropdown.element.querySelector(tt);
          }
          c &&
            ((i = c),
      ...
      (e.prototype._onMouseDown = function (e) {
        ...
        if (t instanceof HTMLElement) {
          if (Ye && this.choiceList.element.contains(t)) {
      ...
      (e.prototype._highlightChoice = function (e) {
        void 0 === e && (e = null);
        var t = Array.from(this.dropdown.element.querySelectorAll(tt));
        if (t.length) {
          var i = e,
            n = this.config.classNames.highlightedState;
          Array.from(this.dropdown.element.querySelectorAll(P(n))).forEach(
            function (e) {
              R(e, n), e.setAttribute("aria-selected", "false");
            }
          ),
            i
      ...
      (e.prototype._removeItem = function (e) {
        if (e.id) {
          ...
          var t = this._notice;
          t && t.type === te && this._clearNotice(),
            this.passedElement.triggerEvent(m, M(e));
        }
      }),
      ...
      (e.prototype._createTemplates = function () {
        var e = this,
          ...
          i = {};
        "function" == typeof t && (i = t.call(this, A, N, F));
        var n = {};
